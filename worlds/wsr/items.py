...
wsr_items: dict[str, WSRItemData] = {
    ...
    "Progressive Fruit (Archery)":                 WSRItemData("Progression", ItemType.progression, 4,7, 0x0702),
    ...
    #Garbage Items
    "100 Skill Points (Swordplay Duel)":                  WSRItemData("Filler", ItemType.filler, 0,0, 0x2000),
    "100 Skill Points (Swordplay Speed Slice)":           WSRItemData("Filler", ItemType.filler, 0,0, 0x2001),
    "100 Skill Points (Swordplay Showdown)":              WSRItemData("Filler", ItemType.filler, 0,0, 0x2002),
    "100 Skill Points (Wakeboarding)":                    WSRItemData("Filler", ItemType.filler, 0,0, 0x2003),
    "100 Skill Points (Frisbee Dog)":                     WSRItemData("Filler", ItemType.filler, 0,0, 0x2004),
    "100 Skill Points (Frisbee Golf)":                    WSRItemData("Filler", ItemType.filler, 0,0, 0x2005),
    "100 Skill Points (Archery)":                         WSRItemData("Filler", ItemType.filler, 0,0, 0x2006),
    "100 Skill Points (Basketball - 3 Point Contest)":    WSRItemData("Filler", ItemType.filler, 0,0, 0x2007),
    "100 Skill Points (Basketball - Pickup Game)":        WSRItemData("Filler", ItemType.filler, 0,0, 0x2008),
    "100 Skill Points (Table Tennis - Return Challenge)": WSRItemData("Filler", ItemType.filler, 0,0, 0x2009),
    "100 Skill Points (Table Tennis - Match)":            WSRItemData("Filler", ItemType.filler, 0,0, 0x200A),
    "100 Skill Points (Golf)":                            WSRItemData("Filler", ItemType.filler, 0,0, 0x200B),
    "100 Skill Points (Bowling - 10-pin Game)":           WSRItemData("Filler", ItemType.filler, 0,0, 0x200C),
    "100 Skill Points (Bowling - 100-pin Game)":          WSRItemData("Filler", ItemType.filler, 0,0, 0x200D),
    "100 Skill Points (Bowling - Spin Control)":          WSRItemData("Filler", ItemType.filler, 0,0, 0x200E),
    "100 Skill Points (Power Cruising)":                  WSRItemData("Filler", ItemType.filler, 0,0, 0x200F),
    "100 Skill Points (Canoeing)":                        WSRItemData("Filler", ItemType.filler, 0,0, 0x2010),
    "100 Skill Points (Cycling)":                         WSRItemData("Filler", ItemType.filler, 0,0, 0x2011),
    "100 Skill Points (Air Sports - Skydiving)":          WSRItemData("Filler", ItemType.filler, 0,0, 0x2012),
    "Extra Max Heart (Swordplay Showdown)":               WSRItemData("Filler", ItemType.filler, 0,0, 0x2013),
    "Extra Max Heart (Cycling)":                          WSRItemData("Filler", ItemType.filler, 0,0, 0x2014),
    "Random Cosmetic":                                    WSRItemData("Filler", ItemType.filler, 0,0, 0x2015),
}
